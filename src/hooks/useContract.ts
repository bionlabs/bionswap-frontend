...
export function useEnumerableNFTContract(nftAddress?: string, withSignerIfPossible?: boolean) {
  return useContract(nftAddress, BION_AVATAR_ABI, withSignerIfPossible);
}
