...
const listingOptions = [
    ...
    },
    {
        ...
        description: 'We will take a part of your raised fund to automatively add liquidity. This process will be done after you complete pre-sale.',
    },
]
                                        ...
                                        listingOptions?.map(item => (
                                            <BoxRadioButtonItem key={item.label}>
                                                <FormControlLabel value={item.value} label={
                                                    <>
                                                        <Typography variant="body4Poppins" color={data.listing == item.value ? 'blue.100' : 'gray.700'} fontWeight="400">
                                                            {item.label}
                                                        </Typography>
                                                ...
                                                <Typography variant="captionPoppins" color={data.listing == item.value ? 'blue.100' : 'gray.700'} fontWeight="400">
                                                    {item.description}
                                                </Typography>
                                            </BoxRadioButtonItem>
                                        ))
                        ...
                        <WrapValue>
                            <FlexBox flexDirection="column" gap="10px">
                                <Typography variant="body4Poppins" color="blue.100" fontWeight="400">
                                    {tokenContract?.symbol} Token needed to launch
                                </Typography>
                                <Typography variant="captionPoppins" color="#717D8A" fontWeight="400">
                                    Token for sale: <Typography variant="captionPoppins" color="blue.100">{tokenForSale}</Typography>
                                </Typography>
                                <Typography variant="captionPoppins" color="#717D8A" fontWeight="400">
                                    Token for Auto liquidity: <Typography variant="captionPoppins" color="blue.100">{tokenForLiquidity}</Typography>
                                </Typography>
                                <Line />
                                <Typography variant="captionPoppins" color="#717D8A" fontWeight="400">
                                    In total: <Typography variant="captionPoppins" color="primary.main">{tokenForSale + tokenForLiquidity} {tokenContract?.symbol}</Typography>
                                </Typography>
                            </FlexBox>
                        </WrapValue>
                    </WrapLine>
