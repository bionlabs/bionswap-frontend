  ...
  return (
    <Wrapper padding={isTablet ? '8rem 16px' : '8rem'}>
      ...
      >
        <Box maxWidth="591px">
          ...
          <Typography variant="h6">
            We have a global distributed network of loyal backers interested in supporting the project of the future,
            like yours.
          </Typography>
        </Box>
        <Box
          ...
          {config.map((item) => (
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={{ color: 'gray.400' }}>{item.label} members</Typography>
              </Box>
            </FlexBox>
          ))}
        </Box>
      ...
      <FlexBox alignItems="center" gap="42px" flexDirection="column">
        <Typography variant={isMobile ? 'h3Samsung' : 'h2'}>All-encompassing support</Typography>
        <Box
          sx={{
            display: 'grid',
            gridTemplateColumns: isTablet ? 'auto auto' : isMobile ? 'auto' : 'auto auto auto',
            alignItems: 'center',
            gap: '60px',
          }}
        >
          {config2.map((item) => (
            ...
            >
              ...
              <FlexBox flexDirection="column">
                ...
                <Typography variant="body4Poppins">{item.content}</Typography>
              </FlexBox>
            </FlexBox>
          ))}
        </Box>
