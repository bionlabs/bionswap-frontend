          ...
          {menuConfig.map((item, index) =>
            item.items.length !== 0 ? (
              ...
              >
                ...
                <AccordionDetails sx={{ marginTop: '10px' }} onClick={toggleDrawer('right', false)}>
                        ...
                        <Link key={i.key} href={i.href} legacyBehavior>
                          <Box sx={{ width: '100%' }}>
                            <Stack spacing={1} alignItems="start">
                              <Typography fontWeight={600}>{i.label}</Typography>
                              {i.description && (
              ...
              <Link key={item.label + index} href={item.href} legacyBehavior>
                <Box onClick={toggleDrawer('right', false)} width="100%">
                  <MenuItem
                    fullWidth
                    sx={{
