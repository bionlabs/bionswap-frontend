import { Box, CircularProgress, ListItem, MenuItem, Stack, Typography } from '@mui/material';
...
const CurrencyRow = ({ currency, style, index, onCurrencySelect, address }: CurrencyRow) => {
