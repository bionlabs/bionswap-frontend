...
const Switch = styled(MuiSwitch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? (theme.palette as any).extra.toggle.background : '#aab4be',
      },
    },
  },
  '& .MuiSwitch-thumb': {
  ...
  '& .MuiSwitch-track': {
    opacity: 1,
    backgroundColor: theme.palette.mode === 'dark' ? (theme.palette as any).extra.toggle.background : (theme.palette as any).extra.toggle.background,
    borderRadius: 20 / 2,
    '&:before, &:after': {
      content: '""',
      position: 'absolute',
